...
genetics-console-ui-window-gene-sequencing-prompt = Begin Sequencing
genetics-console-ui-window-gene-print-prompt = Print Summary
...
genetics-console-ui-window-gene-repair-header = Actions
...
genetics-console-print-report-title = Genetic Sequencing Report: {$name}
genetics-console-print-popup = The console printed out a report.
genetics-console-print-report-gene-type = Type: {$type}
genetics-console-print-report-sequence = Sequence: {$sequence}
genetics-console-print-report-status = Status: {$status}
genetics-console-print-report-mutation-activated = ACTIVE
genetics-console-print-report-mutation-dormant = DORMANT
